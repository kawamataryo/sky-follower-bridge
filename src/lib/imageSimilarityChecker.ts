...
export async function checkImageSimilarity(url1: string, url2: string): Promise<boolean> {
...
function calculateSimilaritySimple(data1: Uint8ClampedArray, data2: Uint8ClampedArray): number {
