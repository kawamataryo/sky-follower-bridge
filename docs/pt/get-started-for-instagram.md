...
O Sky Follower Bridge ajuda você a encontrar e seguir suas conexões do Instagram no Bluesky.
...
### 1. Navegue para o Instagram

Visite qualquer aba de seguindo do Instagram:
- 1. Abra a página do perfil

![open-account-settings](/images/instagram-open-account.png)

- 2. Clique no texto de seguindo
